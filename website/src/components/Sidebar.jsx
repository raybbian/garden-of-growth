...
export default function Sidebar({
    ...
    return (
        ...
        >
            <div
                className={"h-full max-w-[36rem] px-12 mobile:px-8 bg-cream tablet:border-x-2 border-black mobile:border-none"}>
                <div
                    className={"h-auto"}>
                    <div
                    ...
                    <div ref={stageFourRef} className={"py-4"}>
                        ...
                        <form
                            ...
                            className={"flex flex-col gap-6 mt-4 text-base mobile:text-sm"}
                        >
